...
const navItems = [
  { label: "Dashboard", path: "/dashboard", icon: <DashboardIcon />, badge: "LIVE" },
  { label: "Stations & Devices", path: "/devices", icon: <PrecisionManufacturingIcon /> },
  { label: "Live Alarms", path: "/alarms", icon: <NotificationsActiveIcon /> },
  { label: "Downtime & Maintenance", path: "/downtime", icon: <BuildCircleIcon /> },
      ...
      >
        ...
        <Box
          sx={{
            ...
            boxShadow:
              "0 10px 22px rgba(0,0,0,0.45), 0 0 0 1px rgba(120,90,255,0.10) inset",
            overflow: "hidden",
            flexShrink: 0,
            position: "relative",
            "@keyframes scan": {
        ...
        >
          ...
          <Box
            sx={{
              ...
              top: 0,
              background:
                "linear-gradient(180deg, transparent, rgba(0,220,255,0.12), transparent)",
        ...
        {!collapsed && (
          <Chip
            ...
            sx={{
              ...
              color: "rgba(255,255,255,0.92)",
              background:
                "linear-gradient(90deg, rgba(0,220,255,0.18), rgba(120,90,255,0.18))",
              ...
              <Box
                ...
                sx={{
                  ...
                  background: active
                    ...
                    : "transparent",
                  border: active
                    ? "1px solid rgba(120,90,255,0.22)"
